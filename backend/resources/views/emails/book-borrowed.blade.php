                ...
                <table width="600" style="background:#020617;color:#fff;border-radius:12px;padding:30px">
                    ...
                    <tr>
                        <td style="color:#cbd5f5;line-height:1.6">
                            ...
                            You’ve successfully borrowed {{ $borrowRequest->book->title }}. Here are the details:
                            <ul>
                                <li>Borrowed On:
                                    {{ \Carbon\Carbon::parse($borrowRequest->borrowed_date)->format('d/m/Y') }}</li>
                                <li>Due Date: {{ \Carbon\Carbon::parse($borrowRequest->due_date)->format('d/m/Y') }}
                                </li>
                            </ul>
                    ...
                    <tr>
                        <td>
                            <a href="{{ config('app.frontend_url') }}/profile" style="background:#fde68a;color:#000;padding:12px 20px;
